...
[![build](https://github.com/schneidexe/tpl/actions/workflows/release.yml/badge.svg?branch=master)](https://github.com/schneidexe/tpl/actions/workflows/build.yml)
...
```
ADD https://github.com/schneidexe/tpl/releases/download/v{{ .TPL_VERSION }}/tpl-linux-amd64 /bin/tpl
